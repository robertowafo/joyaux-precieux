...
('Le Code de Grâce & Vérité', 'Un protocole en 3 étapes clefs pour résoudre les disputes entre frères et sœurs selon les enseignements d''Éphésiens 4.', '📥 FICHE DE DISCIPLINE SANS PROBLÈME', 'bg-[#fbebeb] border-coral/10', 'text-coral', '🙏 Conseils Bibliques', '/images/resource_3_emotion_wheel.jpg'),
